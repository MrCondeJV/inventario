...
<head>
  ...
  <title>Agregar Usuario | ESFIM</title>
    ...
    <div class="content">
      <div class="page-header">
        <div class="page-title">
          <h4>Administración de usuarios para prestamos</h4>
      ...
      <div class="card shadow">
        <div class="card-body">
          <form action="agregar_usuario_prestamo.php" method="post">
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <a href="userlists_prestamo.php" class="btn btn-danger">Cancel</a>
              </div>
            </div>
          </form>
        </div>
