...
$pdf->SetAuthor('ESFIM');
$pdf->SetTitle('Usuarios de Prestamos y Asignaciones');
...
$html = '<h1 style="font-family: Nunito, sans-serif;">Usuarios de Prestamos y Asignaciones</h1>';
...
$pdf->Output('Reporte_usuarios_prestamos.pdf', 'I');
