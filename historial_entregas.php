...
<body>
              ...
              <tbody>
                ...
                while ($datos = $sql->fetch_object()) { ?>
                  <tr>
                    ...
                    <td>
                      <a href="ver_detalles_entregas.php?id=<?php echo $datos->id; ?>">
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="searchModalLabel">Buscar Entregas</h5>
                  ...
                  <form id="searchForm" onsubmit="return false;">
                    <div class="col-lg-4 col-sm-6 col-12 mb-3">
                      <div class="form-group">
                        <input type="text" name="nombre_equipo" class="form-control" placeholder="Ingrese Nombre del Equipo" oninput="searchEntregas()" />
                      </div>
                    </div>
                  </form>
  ...
  <script>
    function searchEntregas() {
      ...
      xhr.open("POST", "search_entregas.php", true);
