        ...
        <div class="card-body">
          <div class="table-top">
            ...
            <div class="wordset">
              <ul>
                <li>
                  <a data-bs-toggle="tooltip" href="generar_informe_general_prestamos.php" target="_blank" data-bs-placement="top" title="pdf"><img src="assets/img/icons/pdf.svg" alt="img" /></a>
                </li>
              </ul>
            </div>
          </div>
